...
# Codex 规则：如何用全局指令、AGENTS.md 和 Mac 应用在不同仓库中保持一致默认开发规则
...
OpenAI 的 [Codex 文档](https://developers.openai.com/codex/)说明，Codex 会从你的 Codex 主目录读取一个全局指令文件，通常是 `~/.codex/AGENTS.md`。[Codex 配置文档](https://developers.openai.com/codex/config/)也提到，编辑自定义指令会同步更新 `AGENTS.md`。
