...
description: "学习如何在 Cursor IDE 中把 Jupyter Notebook 与 LLM 结合进同一套 AI 工作流，用纯文本笔记本完成数据分析、可视化、文档整理与报告导出，让 AI 在保留预处理与分析上下文的情况下协助编写代码，并在工作时更少地在编辑器、浏览器和聊天窗口之间频繁切换。"
