...
# 从卡壳到顺手：我在 Cursor IDE 里把 Jupyter Notebook 和 LLM 用起来的过程
...
> **更喜欢视频教程？** 我录了一份完整的分步演示。[观看在 Cursor IDE 中使用 Jupyter Notebook 与 AI 做数据分析的视频教程](https://youtu.be/eOSfeBIBzr0?si=M-DfJWF5y1WLt-vL)，可以直接看到整套流程是怎么跑起来的。
...
如果你想进一步了解 Jupyter Notebook 的能力，可以查看 [Jupyter Notebook 官方文档](https://jupyter-notebook.readthedocs.io/en/stable/notebook.html)。
...
如果你想进一步学习更高级的可视化和数据分析技巧，可以参考内容很扎实的 [scikit-learn User Guide](https://scikit-learn.org/stable/user_guide.html)。
