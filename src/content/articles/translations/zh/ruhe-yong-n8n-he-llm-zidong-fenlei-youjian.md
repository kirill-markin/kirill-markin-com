...
这套系统简单得有点离谱：GPT-5-nano 会把每封邮件分到三类之一：归档、阅读或回复。就这么简单。
...
> **说明**：下面这段 prompt 我保留英文原文，方便你直接复制到 n8n 或 OpenAI 节点里使用。它只包含邮件分类逻辑；如果你想看完整的 n8n 自动化工作流（包括所有节点和连接关系），请继续往下滚到“完整 n8n 工作流 JSON”那一节。
