...
description: "ऐसे रचनाकारों के उदाहरण जो अपने ही काम को अप्रासंगिक बना देते हैं: कॉमेडियन जो कॉमेडी को भीतर से काटते हैं, इंजीनियर जो AI से प्रोग्रामरों की जगह लेने वाली प्रणालियाँ बनाते हैं।"
...
मैं कुछ समय से CTO के रूप में काम कर रहा हूँ और सिस्टम बना रहा हूँ।

पिछले 8 महीनों में मैं कुछ ऑटोमेशन सिस्टमों पर काम कर रहा हूँ:

1. एक सिस्टम जो डेटाबेस स्कीमा से बुनियादी CRUD APIs तैयार करता है, ताकि हमें बार-बार वही boilerplate न लिखना पड़े
2. एक scraper जो API docs पढ़ता है और integration code लिखता है (लगभग 70% बार बिना हाथ से सुधार किए काम कर जाता है)
3. requirements से simple mobile apps generate करने का एक प्रयोग (अभी काफ़ी कच्चा है, लेकिन हैरान करने वाली हद तक काम का है)

ये ऐसे AI सहायक नहीं हैं जो चैट में प्रोग्रामरों की मदद करते हों। ये ऐसी प्रणालियाँ हैं जहाँ LLM codebase का ज़्यादातर हिस्सा अपने आप लिखते हैं, और प्रोग्रामर बस समीक्षा करते हैं और जो ठीक करना हो उसे ठीक करते हैं। हम अभी भी ज़रूरी हैं, लेकिन हमारी भूमिका कोड लिखने से हटकर code generation को संचालित करने की हो गई है।
...
जब लोग मुझसे पूछते हैं कि क्या प्रोग्रामर गलती से ऐसा software बना देंगे जो उनकी जगह ले ले, तो मुझे पूरा यक़ीन है कि हम बनाएँगे। गलती से नहीं। जानबूझकर। सिर्फ़ उसकी सुघड़ता के लिए।

इंजीनियरों द्वारा अपनी ही अप्रासंगिकता गढ़ना पूरी तरह recursive है। हम ऐसी प्रणालियाँ बनाते हैं जो हमें गैर-ज़रूरी बना दें। हमें ठीक-ठीक पता है कि हम क्या कर रहे हैं, और फिर भी हम करते रहते हैं, क्योंकि ऑटोमेशन इतना सुघड़ है कि उसका विरोध करना मुश्किल है।
...
मुझे नहीं लगता कि यह रातोंरात होगा। यहाँ last-mile की एक बहुत बड़ी समस्या है। edge cases सँभालने लायक AI systems को fine-tune करने में हमारी सोच से ज़्यादा समय लगेगा। और अभी के लिए, इन प्रणालियों को बेहतर बनाना भी इंजीनियरों के ही जिम्मे है।
...
Bo Burnham कॉमेडी का इस्तेमाल कॉमेडी को खत्म करने में करता है। मैं ऐसे मैनेजमेंट सिस्टम बनाता हूँ जो मैनेजरों को अनावश्यक बनाते हैं। गेम डिज़ाइनर ऐसा मनोरंजन रचते हैं जिसमें खिलाड़ियों को ही गैर-ज़रूरी कर दिया जाता है। इंजीनियर ऐसा कोड लिखते हैं जो इंजीनियरों की जगह लेता है।

यह आत्म-पीड़न या पेशेवर आत्महत्या नहीं है। इसमें कुछ और गहरा है।

मेरी धारणा यह है कि असल में हो क्या रहा है: हम इंजीनियरों की जगह लेने वाली AI इसलिए नहीं बना रहे क्योंकि हमें बनानी ही है। हम यह इसलिए कर रहे हैं क्योंकि यह हमारे सामने आई सबसे दिलचस्प समस्या है।
...
कुछ इंजीनियर कहते हैं कि उन्हें AI के उनकी नौकरियाँ ले लेने की चिंता है। लेकिन देखिए कि वे अपने खाली समय में वास्तव में क्या बना रहे हैं। वे नौकरी बचाने वाली चीज़ें नहीं बना रहे, वे ऑटोमेशन बना रहे हैं।
