...
description: "जानें कि Cursor IDE में Jupyter Notebooks और LLM की मदद से कम संदर्भ-बदलाव के साथ डेटा विश्लेषण, दृश्यांकन और दस्तावेज़ीकरण को एक ही कार्यप्रवाह में कैसे जोड़ा जाए।"
...
# झुंझलाहट से सहज प्रवाह तक: Cursor IDE में Jupyter Notebooks और LLM के साथ मेरी यात्रा
...
> **वीडियो ट्यूटोरियल देखना पसंद है?** मैंने इस पूरे कार्यप्रवाह का चरण-दर-चरण वीडियो बनाया है। [AI-संचालित डेटा विश्लेषण के साथ Cursor IDE में Jupyter Notebooks का ट्यूटोरियल देखें](https://youtu.be/eOSfeBIBzr0?si=M-DfJWF5y1WLt-vL)।
...
तभी मुझे एक ऐसा तरीका मिला जिसने मेरा काम करने का पूरा ढंग बदल दिया: Cursor IDE के भीतर सीधे Jupyter Notebooks चलाना, और उस पर AI की शक्ति जोड़ देना। इस तरीके में एक साथ ये फायदे मिलते हैं:

- Jupyter का इंटरैक्टिव, सेल-आधारित निष्पादन
- एक सक्षम IDE की मजबूत संपादन और नेविगेशन सुविधाएँ
- ऐसी AI सहायता जो कोड और डेटा साइंस, दोनों का संदर्भ समझती है
...
1. Cursor IDE खोलें और एक प्रोजेक्ट फ़ोल्डर बनाएँ
...
2. हर सेल की सामग्री strings की array में रखी जाती है, जिसमें नई पंक्तियों और quotes के लिए escape characters होते हैं
...
- कोड सेल के लिए `# %%` का उपयोग
- दस्तावेज़ीकरण के लिए triple quotes के साथ `# %% [markdown]`
- डेटा लोड करने से खोजबीन और फिर दृश्यांकन तक स्पष्ट तार्किक प्रवाह
...
### Agent Mode: AI-संचालित डेटा साइंस साथी

Cursor IDE में `Composer` बटन पर क्लिक करें और `Agent Mode` चुनें। इससे एक अधिक सक्षम AI सहायक सक्रिय होता है, जो:
...
AI एक पूरा चलाया जा सकने वाला सेल तैयार कर देती है:
...
सिर्फ एक सरल अनुरोध, और हमारे पास ऐसा कोड सेल है जो डेटा सेट को सही ढंग से लोड कर देता है। न आपको सटीक सिंटैक्स याद रखने की ज़रूरत है, न फ़ंक्शन के नाम खोजने की। यह हिस्सा AI संभाल लेती है।
...
AI घूमने वाले दृश्य के साथ एक उन्नत 3D दृश्यांकन तैयार करती है:

[![अलग-अलग क्लस्टर दिखाने वाला Iris डेटा सेट का 3D scatter plot](/articles/assets/jupyter-notebooks/jupyter-3d-visualization.webp)](https://youtu.be/eOSfeBIBzr0?si=M-DfJWF5y1WLt-vL)
...
## बेहतर कोड जनरेशन के लिए Cursor Rules से LLM को दिशा देना

मुझे यह भी पता चला कि प्रोजेक्ट की root directory में `.cursorrules` फ़ाइल बनाकर AI को और उपयोगी बनाया जा सकता है। इस फ़ाइल में वे विशेष निर्देश लिखे जाते हैं, जिनके आधार पर AI कोड तैयार करती है।
...
इससे पता चलता है कि हमारे पास 150 नमूने हैं, हर species के 50, और फूलों के अलग-अलग हिस्सों को मापने वाली 4 विशेषताएँ हैं। अब देखते हैं कि ये विशेषताएँ प्रजातियों के अनुसार कैसे बदलती हैं:
...
इन boxplot से कई रोचक बातें सामने आती हैं। Setosa के बाह्यदल अपेक्षाकृत चौड़े हैं, लेकिन पंखुड़ियाँ छोटी हैं। Virginica की पंखुड़ियाँ सबसे बड़ी दिखाई देती हैं। लेकिन कौन-सी विशेषताएँ प्रजातियों के बीच सबसे साफ़ अंतर दिखाती हैं?
...
3. पंखुड़ी की लंबाई और चौड़ाई, तीनों प्रजातियों के बीच सबसे स्पष्ट अलगाव देती हैं

सबसे प्रभावशाली दृश्यांकन वही 3D scatter plot है, जिसमें तीनों प्रजातियाँ त्रि-आयामी space में अलग-अलग समूह बनाती दिखती हैं। Animation के दौरान कुछ कोण ऐसे सामने आते हैं, जहाँ यह अलगाव बिल्कुल साफ़ दिखाई देता है। स्थिर 2D plot के साथ ऐसी अंतर्दृष्टि पाना लगभग असंभव होता।
...
डेटा साइंस की libraries के साथ संस्करण असंगति आम बात है। इसकी जाँच करने के लिए मैंने स्थापित संस्करण देखने वाला एक सेल जोड़ा:
...
इससे भी बेहतर बात यह थी कि मैंने त्रुटि संदेश AI को दिखाया, और उसने ठीक वही कमांड सुझाई जिसकी ज़रूरत थी। Pop-out terminal और AI सहायता का यह मेल समस्या-सुलझाने को पारंपरिक वातावरण की तुलना में कहीं तेज़ बना देता है।
...
इस heatmap ने दिखाया कि पंखुड़ी की लंबाई और चौड़ाई के बीच 0.96 का बहुत मजबूत correlation है। यानी प्रकृति में ये दोनों विशेषताएँ साथ-साथ बदलती हैं।
...
1. यह सुनिश्चित किया कि सभी सेल चल चुके हों और उनके परिणाम दिखाई दे रहे हों
2. कार्यविधि और निष्कर्ष समझाने के लिए मार्कडाउन सेल जोड़े
...
गैर-तकनीकी हितधारकों के लिए प्रस्तुति तैयार करते समय मैं दृश्यांकनों का आकार उपयुक्त रखता हूँ, जैसे `figsize=(10, 6)`, और छपाई-योग्य गुणवत्ता के लिए high DPI का उपयोग करता हूँ:
...
3. **दस्तावेज़ीकरण**: निष्कर्षों को सीधे कोड के साथ मार्कडाउन सेल में लिखना
4. **साझा करना**: पूरे विश्लेषण को एक ही कमांड से पेशेवर रिपोर्ट के रूप में निर्यात करना

Jupyter की इंटरैक्टिव प्रकृति, Cursor IDE की शक्तिशाली संपादन सुविधाएँ और AI सहायता, इन तीनों के मेल ने वह रुकावट खत्म कर दी है जो पहले मेरी एकाग्रता तोड़ देती थी। अब मैं लगातार टूल बदलने की कीमत चुकाए बिना अपनी जिज्ञासा के पीछे जा सकता हूँ।
...
अगर आप भी डेटा साइंस के काम के लिए कई औज़ार संभालते-संभालते थक चुके हैं, तो इस एकीकृत तरीके को ज़रूर आज़माइए। Cursor IDE में Jupyter की व्यवस्था कीजिए, AI सहायक का लाभ उठाइए, और इस एकजुट कार्यप्रवाह की शक्ति महसूस कीजिए। आपका भविष्य वाला रूप, ख़ासकर रात के 2 बजे वाला, आपको इसके लिए धन्यवाद देगा।
...
| **छिपी हुई स्थिति की समस्या** | `out-of-order execution` के कारण आम | क्रमवार execution के प्रोत्साहन से कम |
