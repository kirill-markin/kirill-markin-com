...
रात के 2 बजे जाकर मैंने आखिर मान लिया कि मैं बुरी तरह अटका हुआ हूँ। मेरा जीनोमिक अनुक्रमण विश्लेषण इसलिए थम गया था क्योंकि Cursor IDE के भीतर मौजूद LLM सहायक मेरी Jupyter Notebook की जटिल JSON संरचना को ठीक से समझ ही नहीं पा रहा था। जब भी मैं अपने दृश्यांकन कोड में मदद मांगता, बदले में टूटा हुआ JSON मिलता जो खुलता तक नहीं था। मैंने छोटे-छोटे अंश भेजकर भी देखा, लेकिन उससे मेरे पूर्व-प्रसंस्करण चरणों का पूरा संदर्भ गायब हो जाता था। ऊपर से तीन अलग-अलग विंडो खुली रहती थीं: ब्राउज़र में Jupyter, "असल" कोड लिखने के लिए VSCode, और दस्तावेज़ लिखने के लिए एक अलग संपादक। Jupyter के फ़ॉर्मैट की सीमाएँ, LLM की दिक्कतें और लगातार टूल बदलने की मजबूरी, इन सबने मिलकर जटिल डेटा-कार्य को लगभग असंभव बना दिया था। Iris जैसे अपेक्षाकृत सरल मानक डेटा सेट पर भी यही बुनियादी असंगति मेरी उत्पादकता को खत्म कर रही थी।
...
1. JSON प्रारूप में बहुत सारे symbols और nested structures होते हैं, जिनका असली सामग्री से सीधा संबंध नहीं होता
...
यही इस तरीके की असली ताकत है: executable code और समृद्ध दस्तावेज़ीकरण, दोनों एक ही सादे-पाठ वाली फ़ाइल में। कोई विशेष file format नहीं, ब्राउज़र-आधारित संपादन की कोई बंदिश नहीं, सिर्फ साफ़ टेक्स्ट जो संस्करण नियंत्रण के साथ बेहतरीन ढंग से चलता है।
...
सिर्फ एक सरल अनुरोध, और हमारे पास ऐसा code cell है जो डेटा सेट को सही ढंग से लोड कर देता है। न आपको सटीक syntax याद रखने की ज़रूरत है, न function names खोजने की। यह हिस्सा AI संभाल लेती है।
...
इन boxplots से कई रोचक बातें सामने आती हैं। Setosa के sepals अपेक्षाकृत चौड़े हैं, लेकिन petals छोटे हैं। Virginica के petals सबसे बड़े दिखाई देते हैं। लेकिन कौन-से features प्रजातियों के बीच सबसे साफ़ अंतर दिखाते हैं?
...
1. Petal measurements वाले किसी भी plot में Setosa बाकी प्रजातियों से पूरी तरह अलग दिखाई देती है
...
यह plot तुरंत दिखा देता है कि petal measurements प्रजातियों को अलग करने में कितनी उपयोगी हैं। Setosa नीचे बाईं ओर एक घना समूह बनाती दिखाई देती है।
...
इस heatmap ने दिखाया कि petal length और petal width के बीच 0.96 का बहुत मजबूत correlation है। यानी प्रकृति में ये दोनों features साथ-साथ बदलते हैं।

लेकिन सबसे उल्लेखनीय दृश्यांकन वही animated 3D scatter plot रहा, जिसे हमने पहले बनाया था। अलग-अलग देखने के कोणों पर घूमते हुए उसने ऐसे क्षण दिखाए, जहाँ तीनों प्रजातियाँ पूरी तरह अलग नज़र आती हैं। यही अंतःक्रियात्मक डेटा दृश्यांकन की असली शक्ति है: अमूर्त संख्याओं को सहज और लगभग अनुभवजन्य समझ में बदल देना।
...
और एक अप्रत्याशित लाभ भी मिला: क्योंकि मैं मूल Jupyter notebooks की बजाय सादे-पाठ वाली फ़ाइलों का उपयोग कर रहा हूँ, मेरा पूरा विश्लेषण अब Git में ठीक से संस्करणबद्ध है। मैं साफ़-साफ़ देख सकता हूँ कि अलग-अलग संस्करणों के बीच क्या बदला, साथ काम करने वालों के साथ `merge conflict` के बिना सहयोग कर सकता हूँ, और अपने काम का साफ़ इतिहास बनाए रख सकता हूँ।
...
| **निर्भरताएँ** | अलग environment files में प्रबंधित | परिवेश के भीतर एकीकृत प्रबंधन |
