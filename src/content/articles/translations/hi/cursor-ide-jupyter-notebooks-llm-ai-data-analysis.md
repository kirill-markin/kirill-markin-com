...
मुझे यह भी समझ आया कि अगर प्रोजेक्ट की मुख्य निर्देशिका में `.cursorrules` फ़ाइल रख दी जाए, तो AI को कहीं अधिक सटीक दिशा दी जा सकती है। इस फ़ाइल में आप अपने प्रोजेक्ट के लिए वे खास निर्देश लिखते हैं, जिनके मुताबिक AI कोड तैयार करती है।

`Cursor Rules` को प्रभावी ढंग से सेट करने और इस्तेमाल करने के लिए आप मेरा विस्तृत लेख [Cursor Rules की मदद से AI-आधारित कोड लेखन को बेहतर बनाने](/articles/cursor-ide-rules-for-ai) पढ़ सकते हैं।
...
इन निर्देशों के बाद AI ने मेरी पसंद के अनुरूप, प्रकार-सुरक्षित कोड बनाना शुरू कर दिया:
...
AI ने मेरे निर्देशों का ठीक वैसा ही पालन किया जैसा मैं चाहता था: स्पष्ट प्रकार-निर्देशन, फलन-आधारित शैली और Pydantic models के साथ।
...
1. पंखुड़ियों के माप वाले किसी भी प्लॉट में Setosa बाकी प्रजातियों से पूरी तरह अलग दिखाई देती है
...
1. नीचे के भाग में दिख रहे terminal icon पर क्लिक करें
...
इससे भी बेहतर बात यह थी कि मैंने त्रुटि संदेश AI को दिखाया, और उसने ठीक वही कमांड सुझाई जिसकी ज़रूरत थी। अलग विंडो में खुली टर्मिनल और AI सहायता का यह मेल समस्या-सुलझाने को पारंपरिक वातावरण की तुलना में कहीं तेज़ बना देता है।
...
[![Jupyter Notebook को पेशेवर PDF रिपोर्ट में बदलना](/articles/assets/jupyter-notebooks/jupyter-pdf-export.webp)](https://youtu.be/eOSfeBIBzr0?si=M-DfJWF5y1WLt-vL)
