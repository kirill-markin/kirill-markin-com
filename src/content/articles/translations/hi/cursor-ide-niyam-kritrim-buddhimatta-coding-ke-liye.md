...
Cursor IDE की एआई सुविधाओं के साथ काम करते हुए मैंने पाया है कि तीनों स्तरों पर नियमों को सोच-समझकर व्यवस्थित करना बहुत जरूरी है। सबसे अहम बात यह है: हर बातचीत में भाषा मॉडल को भेजे जाने वाले tokens यथासंभव कम रखे जाएं। जितना कम अनावश्यक संदर्भ जाएगा, उतनी ज्यादा जगह बेहतर जवाब तैयार करने में लगेगी।

अगर आप Cursor में परियोजना-नियम कैसे काम करते हैं, यह विस्तार से समझना चाहते हैं, तो [Rules for AI पर Cursor का आधिकारिक documentation](https://docs.cursor.com/context/rules) देख सकते हैं।
...
1. **[repo-to-text](https://github.com/kirill-markin/repo-to-text/blob/main/.cursorrules)**: रिपॉज़िटरी को text में बदलने वाले इस उपयोगी औजार में नियम परियोजना का उद्देश्य, स्थापत्य से जुड़े निर्णय, और अपनाए जाने वाले कोड ढर्रे समझाते हैं।

2. **[chatgpt-telegram-bot-telegraf](https://github.com/kirill-markin/chatgpt-telegram-bot-telegraf/blob/main/.cursorrules)**: इस Telegram bot में नियम bot की स्थापत्य-रचना, API के उपयोग के ढर्रों, और संदेशों व commands को संभालने की परंपराओं पर केंद्रित हैं।
...
इस रिपॉज़िटरी में मैंने अलग-अलग rule files बनाई हैं:
...
एक जरूरी सीमा समझने लायक है: context-aware `.mdc` नियम सबसे अच्छा तब काम करते हैं जब उन्हें किसी नई बातचीत की शुरुआत से लागू किया जाए। अगर आप Cursor IDE में पहले से चल रही बातचीत के बीच अचानक कोई खास नियम लागू करना चाहें, जैसे database querying guidelines, तो एआई जरूरी नहीं कि उसे अपने-आप पढ़ ले। ऐसा इसलिए होता है क्योंकि Cursor शुरुआत में संदर्भ तय कर चुका होता है और हर संदेश पर यह दोबारा नहीं परखता कि कौन-से नियम लागू होने चाहिए।

ऐसी स्थिति में मैं सीधा लिख देता हूं: "Please follow our database querying guidelines for this task." इससे Cursor संबंधित नियम ढूंढकर लागू करता है। जिन कामों में किसी खास guideline पर बहुत भरोसा हो, वहां नई बातचीत शुरू करना अक्सर ज्यादा असरदार होता है, क्योंकि तब Cursor शुरुआत से ही सभी जरूरी context-aware नियम उठा लेता है।
...
शुरुआत में मैं सब कुछ Cursor IDE settings में ही डाल देता था। आरंभिक दौर में यह सरल और असरदार था। लेकिन जैसे-जैसे काम करने के तरीके में नए ढर्रे दिखे, वैश्विक नियम बढ़ते गए। फायदा यह था कि हर नई परियोजना उनसे लाभ उठा सकती थी। नुकसान यह कि आखिरकार विन्यास बोझिल हो गया, क्योंकि बहुत से नियम हर जगह लागू नहीं होते थे।
...
जब Cursor IDE में `.cursor/*.mdc` dynamic rules आईं, तो मैंने सब कुछ फिर से व्यवस्थित किया। ये context-aware नियम सिर्फ तभी सक्रिय होते हैं जब एआई वही संबंधित काम कर रहा हो। इससे मुझे यह करने की सुविधा मिली:
...
| **पोर्टेबिलिटी** | हर device पर हाथ से setup | रिपॉज़िटरी clone करते ही साथ | रिपॉज़िटरी clone करते ही साथ |
...
5. छोटे prompts के साथ जांचें कि एआई आपके निर्देशों पर कैसे प्रतिक्रिया दे रहा है

#### स्थानीय Cursor IDE settings को संभालने का व्यावहारिक तरीका

यहां असली बात संतुलन की है: नियम बहुत कम होंगे तो एआई आपकी पसंद नहीं समझेगा; बहुत ज्यादा होंगे तो tokens बेकार के संदर्भ में खर्च होंगे।

यह भी याद रखें कि ये सेटिंग्स आपकी Cursor IDE installation में locally stored होती हैं। आपके सहकर्मी इन्हें तब तक नहीं देखेंगे जब तक वे अपनी machine पर इन्हें खुद configure न करें। और अगर आप Cursor IDE कई computers पर इस्तेमाल करते हैं, जैसे personal और work setup अलग-अलग हों, तो हर installation में इन्हें अलग से सेट करना होगा।
...
3. शुरुआत एक छोटे project overview से कीजिए: परियोजना क्या करती है, stack क्या है, आदि
4. वे स्थापत्य-ढर्रे लिखिए जिन्हें एआई को समझना चाहिए
5. इस परियोजना की विशिष्ट code conventions जोड़िए
6. बेहतर टोकन दक्षता के लिए फ़ाइल को 100 lines के भीतर रखने की कोशिश कीजिए
...
1. अपनी रिपॉज़िटरी में `.cursor/rules/` directory बनाइए
...
इसका सीधा असर यह होता है कि code review में शैली-संबंधी टिप्पणियां कम आती हैं और formatting या cleanup में कम समय लगता है। एक परियोजना में Cursor नियम लागू करने के बाद style-related PR comments लगभग 50% कम हो गए।
...
- engineers और non-engineers, दोनों एक ही दिशा-निर्देश का संदर्भ ले सकते हैं
- एआई अच्छी कार्य-पद्धतियों को लगातार लागू करता है, इसलिए ज्ञान का आदान-प्रदान अपने-आप होने लगता है

यह मुझे खास तौर पर junior developers के onboarding में बहुत उपयोगी लगा है। उन्हें अच्छी कार्य-पद्धतियों पर तुरंत feedback मिल जाता है, code review का इंतजार किए बिना।

### बेहतर एआई संवाद से उत्पादकता में बढ़ोतरी

संख्याएं खुद काफी कुछ बता देती हैं:

- नए सदस्यों को code standards समझाने में लगभग 60% कम समय
- शुरुआती PR submissions लगभग 35% तेज, और revision cycles कम
- git history में style-fix commits लगभग 40% कम

लेकिन सबसे कीमती चीज मानसिक जगह रही है। जब शैली से जुड़ी चिंताएं एआई संभाल लेता है, तो developers असली समस्या पर ज्यादा ध्यान दे सकते हैं।
...
एआई की प्रभावी context window का बेहतर उपयोग करने के लिए:
...
3. **बहुत संकरे नियम**: जरूरत से ज्यादा narrow rules मिलते-जुलते scenarios में लागू नहीं होतीं
4. **Token limitations**: अगर नियम truncate हो रहे हैं, तो उन्हें छोटा और प्राथमिकताबद्ध कीजिए
...
- VS Code में अलग-अलग AI extensions workspace settings और customization files के जरिए ऐसा नियंत्रण देती हैं
...
### Token economy: हर tool में एआई का प्रदर्शन कैसे बेहतर रखें

इन सभी approaches को जोड़ने वाला मूल सिद्धांत एक ही है: **बेहतर नतीजों के लिए टोकन उपयोग को नियंत्रित रखना जरूरी है।** आप कोई भी एआई कोडिंग सहायक इस्तेमाल करें, मॉडल को उतना ही संदर्भ दें जितना जरूरी हो। जरूरत से ज्यादा guidance आम तौर पर मदद नहीं करती।
...
अगर आप चीजें देखकर सीखना पसंद करते हैं, तो मैंने एक विस्तृत वीडियो ट्यूटोरियल बनाया है जो इस तीन-स्तरीय Cursor नियम-व्यवस्था की पूरी implementation दिखाता है:
