...
मैं इस बात से थक गया था कि Gmail अब भी यह नहीं समझ पा रहा था कि मेरे लिए सच में कौन से ईमेल मायने रखते हैं। तीन महीने तक मॉडल से अपने निजी ईमेल वर्गीकृत करवाने के बाद अब हाथ से छंटाई पर लौटने की कल्पना भी मुश्किल लगती है।
...
पूरा सेटअप n8n पर चलता है और इसकी लागत भी लगभग न के बराबर है, क्योंकि मैं `structured output` के साथ OpenAI का सबसे सस्ता मॉडल इस्तेमाल कर रहा हूं। हां, इसका मतलब है कि OpenAI मेरे निजी ईमेल संसाधित करता है, लेकिन सच कहूं तो उसे शायद मेरी ChatGPT बातचीत से ही मेरे बारे में काफी कुछ पहले से पता है।

यह कोई सैद्धांतिक विचार नहीं है जिसे मैं सिर्फ बेचने की कोशिश कर रहा हूं। मैं इसे तीन महीने से अपने वास्तविक कामकाज में चला रहा हूं, और यह हर हफ्ते मेरे कई घंटे बचाता है।
...
> **वीडियो ट्यूटोरियल पसंद है?** मैंने इस पूरे ईमेल ऑटोमेशन वर्कफ़्लो का चरण-दर-चरण वीडियो प्रदर्शन बनाया है। [Email Automation with n8n and LLM Tutorial देखें](https://www.youtube.com/watch?v=xn1RyMlZudE) और पूरा सेटअप वास्तविक रूप में समझें।

[![n8n और LLM के साथ ईमेल ऑटोमेशन वर्कफ़्लो का प्रदर्शन](https://img.youtube.com/vi/xn1RyMlZudE/maxresdefault.jpg)](https://www.youtube.com/watch?v=xn1RyMlZudE)
...
वर्कफ़्लो के भीतर इन फैसलों के लिए `to_hide`, `to_read`, और `to_answer` जैसे सिस्टम लेबल इस्तेमाल किए गए हैं, लेकिन पाठक के नज़रिए से अर्थ यही तीन हैं।

कोई जटिल फ़ोल्डर संरचना नहीं। कोई प्राथमिकता स्तर नहीं। सिर्फ तीन सीधे फैसले, जो मेरे लगभग सभी ईमेल को समेट लेते हैं।
...
अपने वर्कफ़्लो में आपको ये नोड जोड़ने होंगे:
...
असल जादू OpenAI नोड की कॉन्फ़िगरेशन में है। मैं इसे इस तरह सेट करता हूं:

![n8n में OpenAI LLM नोड की कॉन्फ़िगरेशन](/articles/assets/n8n-llm-node-config.webp)
...
> **नोट**: यह सिर्फ ईमेल वर्गीकरण के लिए LLM प्रॉम्प्ट है। अगर आप पूरा n8n वर्कफ़्लो ऑटोमेशन देखना चाहते हैं, जिसमें सभी नोड और उनके कनेक्शन शामिल हैं, तो नीचे "पूरा n8n वर्कफ़्लो JSON" अनुभाग तक जाएं।
...
5% की त्रुटि दर मेरे लिए पूरी तरह संभालने लायक है। जब मॉडल गलती करता है, तो मैं ईमेल को सही श्रेणी में ले जाता हूं और आगे बढ़ जाता हूं। फिर भी यह हर ईमेल को हाथ से छांटने से कहीं तेज़ है।
...
4. **वर्कफ़्लो आयात करें** - अगर लोगों की दिलचस्पी होगी, तो मैं JSON export साझा कर दूंगा
...
और सबसे अच्छी बात यह है कि मैं जब चाहूं इसका तर्क बदल सकता हूं। चौथी श्रेणी चाहिए? प्रॉम्प्ट बदल दीजिए। कुछ खास भेजने वालों के ईमेल अलग ढंग से संभालने हैं? एक अतिरिक्त शर्त वाला `condition node` जोड़ दीजिए। Gmail के नियम कड़े और सीमित हैं; यह सिस्टम मेरी जरूरत के साथ ढल जाता है।
