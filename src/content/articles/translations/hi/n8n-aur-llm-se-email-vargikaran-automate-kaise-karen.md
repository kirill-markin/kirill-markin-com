...
# n8n और LLM के साथ ईमेल वर्गीकरण अपने-आप कैसे करें

मैं इस बात से थक चुका था कि Gmail अब तक यह नहीं समझ पाया कि मेरे लिए सच में कौन से ईमेल मायने रखते हैं। तीन महीने तक AI से अपने निजी ईमेल वर्गीकृत करवाने के बाद अब हाथ से छंटाई पर लौटने की कल्पना भी मुश्किल लगती है।

मेरा सिस्टम जितना असरदार है, उतना ही सीधा भी है: GPT-5-nano हर ईमेल को तीन में से एक श्रेणी में रख देता है। संग्रहित करें, पढ़ें या जवाब दें। बस।

पूरा सेटअप n8n पर चलता है और इसकी लागत भी लगभग न के बराबर है, क्योंकि मैं structured output के साथ OpenAI का सबसे सस्ता मॉडल इस्तेमाल कर रहा हूं। हां, इसका मतलब है कि OpenAI मेरे निजी ईमेल प्रोसेस करता है, लेकिन सच कहूं तो उसे शायद मेरी ChatGPT बातचीत से ही मेरे बारे में काफी कुछ पहले से पता है।

यह कोई सैद्धांतिक विचार नहीं है जिसे मैं सिर्फ बेचने की कोशिश कर रहा हूं। मैं इसे तीन महीने से अपने असली कामकाज में चला रहा हूं, और यह हर हफ्ते मेरे कई घंटे बचाता है।

## मैंने यह ईमेल ऑटोमेशन सिस्टम क्यों बनाया

मुझे जरूरत से कहीं ज्यादा ईमेल मिलते हैं। न्यूज़लेटर, अलग-अलग सेवाओं की सूचनाएं, और असली लोगों के जरूरी संदेश, सब कुछ एक ही इनबॉक्स में आकर जमा हो जाता है। Gmail की बनी-बनाई वर्गीकरण व्यवस्था बार-बार साफ पैटर्न पकड़ने से चूक रही थी, और मैं हर सुबह करीब 20 मिनट सिर्फ यह तय करने में लगा देता था कि क्या पढ़ना है।
...
## तीन-श्रेणी वाली प्रणाली जो सचमुच काम करती है

मेरा AI हर ईमेल को ठीक तीन विकल्पों में से एक में रखता है:

- **Archive** - वे न्यूज़लेटर जिनकी सदस्यता तो ली है लेकिन मैं उन्हें पढ़ता नहीं, स्वचालित सूचनाएं, और प्रचार वाले ईमेल
- **Read** - ऐसी सामग्री जिसे मैं पढ़ना चाहता हूं, लेकिन जिसका जवाब देना जरूरी नहीं
- **Answer** - ऐसे ईमेल जिनका जवाब मुझे खुद देना है

कोई जटिल फ़ोल्डर संरचना नहीं। कोई प्राथमिकता स्तर नहीं। सिर्फ तीन सीधे फैसले, जो मेरे 100% ईमेल को समेट लेते हैं।

## n8n वर्कफ़्लो कैसे सेट करें

यह पूरा n8n वर्कफ़्लो है जो सब कुछ अपने-आप संभालता है:

![n8n ईमेल वर्गीकरण वर्कफ़्लो](/articles/assets/n8n-email-workflow-full.webp)

मेरे Gmail इनबॉक्स में नया ईमेल आते ही यह वर्कफ़्लो चल पड़ता है। यह ईमेल की सामग्री उठाता है, वर्गीकरण के लिए OpenAI को भेजता है, फिर सही Gmail लेबल लगाता है और जिन ईमेल पर मुझे ध्यान नहीं देना, उन्हें संग्रहित कर देता है।

### ज़रूरी n8n nodes

अपने वर्कफ़्लो में आपको ये nodes जोड़ने होंगे:
...
असल जादू OpenAI node की कॉन्फ़िगरेशन में है। मैं इसे इस तरह सेट करता हूं:

![n8n में OpenAI LLM node की कॉन्फ़िगरेशन](/articles/assets/n8n-llm-node-config.webp)

## वह LLM प्रॉम्प्ट जो इस सिस्टम को चलाता है

यह प्रॉम्प्ट इस सिस्टम का केंद्र है। दर्जनों अलग-अलग रूप आजमाने के बाद मुझे यही संस्करण सबसे लगातार सही नतीजे देता है:

> **नोट**: यह सिर्फ ईमेल वर्गीकरण के लिए LLM प्रॉम्प्ट है। अगर आप पूरा n8n वर्कफ़्लो ऑटोमेशन देखना चाहते हैं, जिसमें सभी nodes और उनके connections शामिल हैं, तो नीचे "पूरा n8n वर्कफ़्लो JSON" अनुभाग तक जाएं।
...
मैं structured output इस्तेमाल करता हूं ताकि AI हमेशा मान्य श्रेणी ही लौटाए। इससे न पार्सिंग की गड़बड़ियां होती हैं, न ऐसे हालात बनते हैं जहां मॉडल जवाब के प्रारूप में अपनी तरफ से कुछ नया गढ़ने लगे।
...
5% की त्रुटि दर मेरे लिए पूरी तरह संभालने लायक है। जब AI गलती करता है, तो मैं ईमेल को सही श्रेणी में ले जाता हूं और आगे बढ़ जाता हूं। फिर भी यह सब कुछ हाथ से छांटने से कहीं तेज़ है।

## सुरक्षा से जुड़ी बातें और मैं इससे सहज क्यों हूं

हां, OpenAI अब मेरे सभी निजी ईमेल प्रोसेस करता है। गोपनीयता के लिहाज से यह आदर्श नहीं है, लेकिन कुछ वजहों से मैं इसके साथ सहज हूं।
...
4. **वर्कफ़्लो आयात करें** - लोग चाहेंगे तो मैं JSON export साझा कर दूंगा
...
## यह Gmail की अंतर्निहित सुविधाओं से बेहतर क्यों है
...
और सबसे अच्छी बात यह है कि मैं जब चाहूं इसका तर्क बदल सकता हूं। चौथी श्रेणी चाहिए? प्रॉम्प्ट बदल दीजिए। कुछ खास भेजने वालों के ईमेल अलग ढंग से संभालने हैं? एक condition node जोड़ दीजिए। Gmail के नियम कड़े और सीमित हैं; यह सिस्टम मेरी जरूरत के साथ ढल जाता है।
...
## पूरा n8n वर्कफ़्लो JSON

जो लोग इस सिस्टम को तुरंत लागू करना चाहते हैं, उनके लिए यहां पूरा n8n वर्कफ़्लो दिया गया है, जिसे आप सीधे आयात कर सकते हैं:

<details>
<summary>पूरा JSON वर्कफ़्लो देखने के लिए क्लिक करें</summary>
...
5. अपने Gmail और OpenAI क्रेडेंशियल्स कॉन्फ़िगर करें।
...
7. त्रुटि आने पर भेजे जाने वाला वैकल्पिक ईमेल सेट करें।
8. ट्रिगर चालू करने से पहले कुछ ईमेल के साथ परीक्षण करें।

वर्कफ़्लो आयात करने के बाद OpenAI API key और Gmail authentication को अपडेट करना याद रखें।
...
वीडियो में n8n वर्कफ़्लो बनाना, OpenAI इंटीग्रेशन कॉन्फ़िगर करना, Gmail कनेक्शन सेट करना, और पूरे ऑटोमेशन का परीक्षण करना हर चरण में दिखाया गया है। आप nodes की सटीक कॉन्फ़िगरेशन, LLM प्रॉम्प्ट का वास्तविक उपयोग, और सिस्टम को वास्तविक समय में ईमेल वर्गीकृत करते हुए देखेंगे।
