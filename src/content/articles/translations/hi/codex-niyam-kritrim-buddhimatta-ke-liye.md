...
Codex CLI यह हिस्सा पहले से अच्छी तरह करता है। Mac ऐप उसी आधारभूत कार्यप्रवाह को बस अधिक साफ और सुखद रूप देता है। मैं हर नए काम में बार-बार वही बातें नहीं सिखाना चाहता: सख्त typing, छोटे और साफ बदलाव, स्पष्ट errors, बेवजह के fallback नहीं, और बिखरी हुई व्याख्याओं की जगह code के भीतर लिखी docstrings। मैं चाहता हूं कि यह आधार शुरू से मौजूद रहे।
...
OpenAI के [Codex docs](https://developers.openai.com/codex/) कहते हैं कि Codex आपकी Codex home directory में रखी वैश्विक निर्देश-फ़ाइल पढ़ सकता है, जो आम तौर पर `~/.codex/AGENTS.md` होती है। [Codex settings docs](https://developers.openai.com/codex/config/) यह भी कहते हैं कि custom instructions में किया गया बदलाव आपकी निजी `AGENTS.md` को अपडेट करता है।
...
- सरल, एक ही काम करने वाले फ़ंक्शन लिखें - बहु-मोड व्यवहार नहीं, और ऐसे flag parameters नहीं जो तर्क बदल दें

## त्रुटि-प्रबंधन

- त्रुटियों को हमेशा स्पष्ट रूप से उठाएं, उन्हें चुपचाप अनदेखा न करें
- ऐसे विशिष्ट error types इस्तेमाल करें जो साफ बताएं कि क्या गलत हुआ
- ऐसे catch-all exception handlers से बचें जो मूल कारण छिपा दें
- error messages साफ और काम के होने चाहिए
- fallbacks तभी रखें जब मैं उन्हें स्पष्ट रूप से मांगूं
- लक्षण नहीं, मूल कारण ठीक करें
- बाहरी API या service calls में retries और warnings का उपयोग करें, फिर आखिरी त्रुटि उठाएं
...
- `pyproject.toml` और `package.json` जैसी modern package management files को प्राथमिकता दें
...
- repository की मौजूदा testing strategy और मौजूदा test suite का सम्मान करें
...
- code ही मुख्य दस्तावेज़ीकरण है - साफ naming, types, और docstrings का उपयोग करें
- दस्तावेज़ीकरण को उन्हीं functions या classes की docstrings में रखें जिनका वह वर्णन करती है, अलग files में नहीं
- अलग documentation files तभी बनाएं जब कोई अवधारणा code में साफ व्यक्त न हो सकती हो
...
इसका काम बस बार-बार की झुंझलाहट हटाना है:

- जब मुझे छोटा सा patch चाहिए हो, तब Codex का बेवजह बड़ा refactor शुरू कर देना
- Codex का अपनी अनिश्चितता को मुलायम भाषा के पीछे छिपा देना
- "सुरक्षा" के नाम पर अनावश्यक fallback behavior जोड़ देना
- प्रॉम्प्ट बहुत संकरा होने पर रिपॉज़िटरी की परंपराओं को अनदेखा कर देना
...
Codex में `AGENTS.md` की परतदार व्यवस्था का अच्छा समर्थन है। OpenAI वैश्विक फ़ाइल `~/.codex/AGENTS.md` का ज़िक्र करता है, और फिर जैसे-जैसे working directory अधिक विशिष्ट होती जाती है, वैसे-वैसे रिपॉज़िटरी और अंदर की निर्देशिका-फ़ाइलें लागू होती जाती हैं।
...
- बदलाव करते समय agent कितना आक्रामक हो
- सामान्य coding work में "done" किसे माना जाए

रिपॉज़िटरी फ़ाइल को इन सवालों का जवाब देना चाहिए:

- यह codebase किस तरह व्यवस्थित है
- कौन सी commands चलानी हैं
- कौन से हिस्से नाज़ुक हैं
- टीम PRs, commits या docs को कैसे संभालना चाहती है

संक्षेप में:

- व्यक्तिगत `AGENTS.md` बताता है कि मैं कैसे काम करता हूं
- रिपॉज़िटरी `AGENTS.md` बताता है कि यह codebase कैसे काम करती है
...
Mac ऐप मेरा मुख्य इंटरफ़ेस है। CLI कोई गौण fallback नहीं है। वह वही Codex व्यवस्था है, बस अलग रूप में।

CLI कुछ वजहों से अब भी महत्वपूर्ण है:

- यह फ़ाइल-आधारित विन्यास को बहुत साफ बना देता है
- ठीक-ठीक व्यवहार को जांचना या उसे script में ढालना इसमें आसान होता है

मैं CLI के लिए अलग नज़रिया नहीं चाहता। मैं वही व्यक्तिगत `AGENTS.md`, वही रिपॉज़िटरी मार्गदर्शन, और दोनों में वही सीमाएं चाहता हूं।
...
- चुपचाप काम करने वाले fallbacks नहीं
- minimal diffs
- बिखरे हुए docs की जगह code के भीतर लिखी docstrings
- साफ terminal habits

### 3. रिपॉज़िटरी AGENTS.md सिर्फ रिपॉज़िटरी-सत्य के लिए जोड़ें

यहीं commands, architecture, constraints, naming, testing expectations और संवेदनशील हिस्सों की जानकारी होनी चाहिए। यही रिपॉज़िटरी वाली परत है।
