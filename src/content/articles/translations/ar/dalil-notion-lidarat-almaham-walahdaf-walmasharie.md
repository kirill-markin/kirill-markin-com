...
**هذا النظام يلغي الانهيارات الجليدية لأن التاريخ فيه هو الاستثناء لا القاعدة.** معظم المهام تبقى بلا `Action Date`، وتُنظَّم عبر `Sort Position`. أما التواريخ فتُحجز فقط للمواعيد الحقيقية، وبذلك تبقى قائمة "النشطة" اليومية بين 3 و7 عناصر قابلة للإدارة.
