export const meet = {
    ...
    hi: {
        ...
        metaTitle: 'किरिल मार्किन के साथ बैठक तय करें | समय के लचीले विकल्प',
        metaDescription: 'किरिल मार्किन के साथ बातचीत तय करें और अपनी जरूरत, चर्चा की गहराई और दिन के उपलब्ध समय के हिसाब से 15, 30 या 60 मिनट का सही समय चुनें, ताकि बात आसानी से हो सके।',
        shortMeeting: {
            title: '15 मिनट की बैठक',
            description: 'जब ज्यादा समय न चाहिए, तब यह छोटी अवधि ठीक रहती है। संक्षिप्त हालचाल, जल्दी सवाल, या सिर्फ नमस्ते कहने के लिए यह अच्छा विकल्प है।',
            metaTitle: 'किरिल मार्किन के साथ 15 मिनट की बैठक तय करें | संक्षिप्त बातचीत',
            metaDescription: 'किरिल मार्किन के साथ 15 मिनट की बैठक तय करें। जल्दी बात करने, संक्षिप्त हालचाल लेने या कुछ मिनट निकालकर जुड़ने के लिए यह बढ़िया विकल्प है, खासकर जब विषय साफ हो।',
        },
        mediumMeeting: {
            title: '30 मिनट की बैठक',
            description: 'किसी खास विषय पर ढंग से बात करने के लिए आधा घंटा। यह उन ज़्यादातर बातचीतों के लिए सही है जिनमें छोटी-सी बातचीत से थोड़ा अधिक समय चाहिए।',
            metaTitle: 'किरिल मार्किन के साथ 30 मिनट की बैठक तय करें | केंद्रित चर्चा',
            metaDescription: 'किरिल मार्किन के साथ 30 मिनट की बैठक तय करें। किसी विषय पर केंद्रित चर्चा, परियोजना की समीक्षा, या मिलकर बातों को समझने के लिए यह अच्छा समय है।',
        },
        longMeeting: {
            title: '60 मिनट की बैठक',
            description: 'जब किसी जटिल विषय पर ठीक से काम करना हो, तब पूरा एक घंटा सही रहता है। गहरी बातचीत, साक्षात्कार, या ऐसे मुद्दों के लिए यह अच्छा है जिन्हें सच में समय चाहिए।',
            metaTitle: 'किरिल मार्किन के साथ 60 मिनट की बैठक तय करें | गहन चर्चा',
            metaDescription: 'किरिल मार्किन के साथ 60 मिनट की बैठक तय करें। गहन बातचीत, साक्षात्कार, या जटिल विषयों पर विस्तार से बात करने के लिए यह सही विकल्प है।',
        },
        allMeetings: {
            title: 'बैठक के सभी विकल्प',
            description: 'बैठक की सभी उपलब्ध अवधियां एक ही जगह हैं। जो आपके कार्यक्रम में सबसे बेहतर बैठे, वही चुनें।',
            metaTitle: 'किरिल मार्किन के साथ बैठक के सभी विकल्प | अपनी अवधि चुनें',
            metaDescription: 'किरिल मार्किन के साथ उपलब्ध बैठक के सभी विकल्प देखें और अपनी जरूरत, बातचीत की प्रकृति और कार्यक्रम के अनुसार 15, 30 या 60 मिनट का सही समय चुनें।',
        },
        shortPageTitle: '15 मिनट की बैठक',
        mediumPageTitle: '30 मिनट की बैठक',
        longPageTitle: '60 मिनट की बैठक',
        allPageTitle: 'बैठक के सभी विकल्प',
