...
✅ **Do**: Use first-person, vary sentence length, include mild colloquialisms, express genuine feelings, add occasional asides, provide specific examples with concrete details.

❌ **Avoid**: Hedging language, unnecessary qualifiers, academic detachment, formal transitions, robotic parallelism, grandiose statements, abstract generalizations without examples.

## Vocabulary

✅ **Do**: Explain jargon casually, use colorful verbs, natural metaphors, contractions, relevant references, simple words.

❌ **Avoid**: AI phrases ("It is worth noting"), thesaurus abuse, complex vocabulary, generic statements, perfectly balanced viewpoints.

## Structure

✅ **Do**: Start with conversational hooks, casual section headings, one-sentence paragraphs, rhetorical questions, brief anecdotes.

❌ **Avoid**: Symmetrical structure, parallel headings ("The Power of X, The Impact of Y"), predictable organization, unnecessary previews.
...
❌ **Avoid**: "The secret? One database rules them all."
❌ **Avoid**: "What's the solution? Simple task management."
❌ **Avoid**: "The result? Increased productivity."
✅ **Good**: "What makes it work is embarrassingly simple: everything lives in one database."
✅ **Good**: "The solution turned out to be simpler than I expected."

### Short Dramatic Reveals
❌ **Avoid**: "The answer? Three simple steps."
❌ **Avoid**: "The key? Consistency."
❌ **Avoid**: "My approach? Start small."
✅ **Good**: "I found three steps that actually worked."
✅ **Good**: "Consistency made all the difference."

### Self-Answering Questions in Same Paragraph
❌ **Avoid**: "Why does this work? Because it eliminates complexity."
❌ **Avoid**: "What changed everything? A single Notion table."
✅ **Good**: "This works because it eliminates unnecessary complexity."
✅ **Good**: "Everything changed when I moved to a single Notion table."

### Self-Questioning Pattern (Major AI Red Flag)
❌ **Avoid**: Questions to yourself or your audience that you immediately answer:
...
✅ **Good**: Direct statements without artificial questions:
...
❌ **Avoid**: Using emojis as bullet points in lists:
```
...
✅ **Good**: Natural paragraph flow or simple text lists:
```
...
✅ **Good**: Understated, personal language:
- "This actually works"
...
❌ **Avoid**: Generic engagement hooks:
- "What are your thoughts?"
- "Let me know in comments"
- "What's your experience?"

✅ **Good**: Specific, relatable questions:
...
### Hashtag Usage
❌ **Avoid**: Using hashtags in social media posts:
```
#AI #Cursor #DeveloperTools #Productivity
```

✅ **Good**: Focus on natural content without hashtags:
```
...
✅ **Good**: "I spent 3 hours debugging a TypeScript error that turned out to be a missing semicolon on line 47 of my authentication middleware."

❌ **Bad**: "Debugging can be time-consuming and often involves identifying small syntax errors in your codebase."

✅ **Good**: "Yesterday I saved 2 hours by using Cursor's duplicate chat feature when I wanted to try a different approach to my React component structure."

❌ **Bad**: "AI tools can significantly improve developer productivity through various features."
...
✅ **Good**: Understated, honest language:
...
**Process**: Research keywords → Add to frontmatter → Create keyword outline → Write value-focused draft → Review keyword placement → Check all locations → Confirm natural style
